...
RESPONSES_HOST_SEND = os.environ.get('RESPONSES_HOST_SEND', '127.0.0.1')
RESPONSES_HOST_BIND = os.environ.get('RESPONSES_HOST_BIND', '0.0.0.0')
REQUESTS_HOST_BIND = os.environ.get('REQUESTS_HOST_BIND', '0.0.0.0')
